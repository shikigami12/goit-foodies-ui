...
export const SignUpModal = ({ onSwitchToSignIn, onClose }) => {
    ...
    return (
        <section className="relative w-[561px] max-w-full px-10 py-20 rounded-[30px] bg-white flex justify-center">
            <div className="flex flex-col gap-10 w-full max-w-[401px]">
